...
@section('content')
    <x-content.container-fluid>
        ...
        <x-content.table-container>
            ...
            <x-content.card-body>
                <form id="main-form" action="{{ route('purchase-report.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('purchase-report.index') }}" class="btn btn-warning ml-2">Kembali</a>
                    </div>
                </form>
            </x-content.card-body>
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href =
                                "{{ route('purchase-report.index') }}"; // Redirect to index page
                        } else {
